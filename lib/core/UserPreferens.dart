...
class UserPreferences {
  ...
  void setUserLogin(String user) {
    _prefs.setString('userLogin', user);
  }

  get userLogin => _prefs.getString('userLogin');
  ...
  // String get callcenternumber => _prefs.getString('pref_callcenternumber');
  ...
  // set callcenternumber(String data) {
  //   _prefs.setString('pref_callcenternumber', data);
  // }
